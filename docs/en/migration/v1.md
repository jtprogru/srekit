...
- A `.tmpl` for `capacity`, `retro` or `license` still converts, but those commands were [removed in v0.30.0](removed-commands.md) — the resulting `.yaml` has nothing to render it. Skip them.
